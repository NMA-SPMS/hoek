...
exports.base64urlEncode = function (value, encoding) {
    ...
    const buf = value; //(Buffer.isBuffer(value) ? value : new Buffer(value, encoding || 'binary'));
...
exports.base64urlDecode = function (value, encoding) {
    ...
    const buf = value //new Buffer(value, 'base64');
...
exports.uniqueFilename = function (path, extension) {
    ...
    console.log("not implemented to make hoek work in nativescript")
};
